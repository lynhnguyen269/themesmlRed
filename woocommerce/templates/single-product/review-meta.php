...
if ( '0' === $comment->comment_approved ) { ?>
	...
	<p class="meta"><em class="woocommerce-review__awaiting-approval"><?php esc_attr_e( 'Your review is awaiting approval', 'redbiz' ); ?></em></p>
...
<?php } else { ?>
	...
	<p class="meta">		
		...
		if ( 'yes' === get_option( 'woocommerce_review_rating_verification_label' ) && $verified ) {
			echo '<em class="woocommerce-review__verified verified">(' . esc_attr__( 'verified owner', 'redbiz' ) . ')</em> ';
		}
