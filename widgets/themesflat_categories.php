...
class Themesflat_Categories extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            'widget_categories',
            esc_html__( 'Themesflat - Categories', 'redbiz' ),
            array(
                'classname'   => 'widget_categories',
                'description' => esc_html__( 'Categories.', 'redbiz' )
            )
        );
    }
    ...
    function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'custom_ids' ) ); ?>"><?php esc_html_e( 'Custom Categories By Ids- EX: 1,2,3', 'redbiz' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'child_of' ) ); ?>"><?php esc_html_e( 'Child Of:', 'redbiz' ); ?></label>
        ...
        <p>
            ...
            <label for="<?php echo esc_attr( $this->get_field_id( 'show_count' ) ); ?>"><?php esc_html_e( 'Show count?', 'redbiz' ); ?></label>
        </p>
    <?php
    }
}
