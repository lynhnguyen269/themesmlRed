...
class Themesflat_Testimonial_widgets extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct(
            ...
            esc_html__( 'Themesflat - Testimonial', 'redbiz' ),
            array(
                'classname'   => 'widget-themesflat-testimonial',
                'description' => esc_html__( 'Testimonial', 'redbiz' )
                )
            );
    }
    ...
    function form( $instance ) {
        ...
        <?php $styles = array(
            'sidebar' => esc_html__('Sidebar','redbiz'),
            ...
            <p>
                ...
                <label for="<?php echo esc_attr( $this->get_field_id( 'show_control' ) ); ?>"><?php esc_html_e( 'Show Control ?', 'redbiz' ) ?></label>
            </p>       
            ...
            <p>
                ...
                <label for="<?php echo esc_attr( $this->get_field_id( 'show_direction' ) ); ?>"><?php esc_html_e( 'Show Direction ?', 'redbiz' ) ?></label>
            </p>   
            ...
            <p>
                ...
                <label for="<?php echo esc_attr( $this->get_field_id( 'autoplay' ) ); ?>"><?php esc_html_e( 'Auto Play ?', 'redbiz' ) ?></label>
            </p>       
            <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'limit' ) ); ?>"><?php esc_html_e( 'Limit:', 'redbiz' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'post_in' ) ); ?>"><?php esc_html_e( 'Include:', 'redbiz' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'exclude' ) ); ?>"><?php esc_html_e( 'Exclude:', 'redbiz' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'class' ) ); ?>"><?php esc_html_e( 'Class:', 'redbiz' ); ?></label>
