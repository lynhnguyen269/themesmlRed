...
$next_link = get_next_posts_link( esc_html__( 'Next', 'redbiz' ) );
$prev_link = get_previous_posts_link( esc_html__( 'Previous', 'redbiz' ) );
$loadmore_text = apply_filters('themesflat/template/loadmore_text',esc_html__('Load More','redbiz'));
